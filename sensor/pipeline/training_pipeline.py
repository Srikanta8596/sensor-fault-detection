...
class TrainPipeLine:
    ...
    def start_data_ingestion(self)-> DataIngestionArtifact:
        try:
            ...
            data_ingestion_artifact=data_ingestion.initiated_data_ingestion()
    ...
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact) -> DataValidationArtifact:
        try:
            ...
            data_validatipon_artifact= data_validation.initiate_data_validation()
            return data_validatipon_artifact
